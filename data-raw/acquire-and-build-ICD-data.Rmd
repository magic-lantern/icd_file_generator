...
vignette: >
  ...
  %\VignetteIndexEntry{icd-datasets}
...
#'
#' @format a data frame with", qwraps2::frmt(nrow(icd9pc)), "rows and 3 columns.
#' \\describe{
#' \\item{code}{A character string of alpha numerics representing the ICD-9
#' procedure code.}
...
#'
#' @format a data frame with", qwraps2::frmt(nrow(icd10dx)), "rows and 2 columns.
#' \\describe{
...
#'
#' @format a data frame with", qwraps2::frmt(nrow(icd10pc)), "rows and 2 columns.
#' \\describe{
#' \\item{code}{A character string of alpha numerics representing the ICD-10
#' procedure code.}
...
\"icd10pc\"
",
file = "../R/icd-dataset.R")
```


# Save the Data Sets
```{r}
icd9dx  <- data.table::as.data.table(icd9dx)
icd9pc  <- data.table::as.data.table(icd9pc) 
icd10dx <- data.table::as.data.table(icd10dx)
icd10pc <- data.table::as.data.table(icd10pc)
